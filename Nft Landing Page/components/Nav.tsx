    ...
    <div className="h-[12vh] bg-[#111D5e]">
      <div className="w-[90%] flex items-center h-[100%] justify-between mx-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="w-[2rem] hover:bg-red-600 cursor-pointer transition-all duration-200 h-[2rem] sm:w-[3.2rem] sm:h-[3.2rem] rounded-full flex items-center justify-center bg-[#0000003d]">
            <UserIcon className="w-[1.3rem] h-1.3rem] text-white" />
          </div>
          <div className="w-[2rem] hover:bg-red-600 relative cursor-pointer transition-all duration-200 h-[2rem] sm:w-[3.2rem] sm:h-[3.2rem] rounded-full flex items-center justify-center bg-[#0000003d]">
            <ShoppingBagIcon className="w-[1.3rem] h-1.3rem] text-white"/>
            <span className="w-[0.7rem] h-[0.7rem] sm:w-[1.1rem] sm:h-[1.1rem] text-[10px] sm:-inset-0text-[13px] absolute top-0 right-0 flex items-center justify-center bg-red-600 rounded-full text-white">4</span>
          </div>
